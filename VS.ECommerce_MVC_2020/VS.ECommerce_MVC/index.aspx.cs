    ...
    public partial class index1 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!base.IsPostBack)
            {
                ...
                #region MetaFacebook
                ltFacebook.Text += App.Template.Facebook(ssl + Request.Url.Host, hp);
                ...
                child.Name = "keywords";
                child.Content = App.Template.Keyword(hp);
                base.Header.Controls.Add(child);
                HtmlMeta meta2 = new HtmlMeta();
                meta2.Name = "description";
                meta2.Content = App.Template.Description(hp);
            ...
            if (!bc.Contains("localhost"))
            {
                if (Request["su"] == null)
                {
                    ...
                    if (Commond.Setting("Thongbao").Equals("1"))
                    {
                        ...
                        {
                            Response.Write("<div style='display : block ! important;visibility : visible ! important;margin : 0 auto 10px ;position : relative ! important;z-index : 2147483647 ! important;width : 1000px;color:#fff; Background:#ffcb08; width:100%; padding:20px; border-radius:5px;'>" + Commond.Setting("Show") + "</div>");
                        }
                    }
                    ...
                    {
                        Response.Redirect(ssl + Commond.Setting("Redirectwebsite"));
                    }
                }
            }
        }

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Index.ascx.cs" Inherits="VS.ECommerce_MVC.cms.Display.News.Index" %>
<%@ Register TagPrefix="cc1" Namespace="SiteUtils" Assembly="CollectionPager" %>
<%--<%@ OutputCache Duration="60" VaryByParam="*" VaryByControl="hp" %>--%>

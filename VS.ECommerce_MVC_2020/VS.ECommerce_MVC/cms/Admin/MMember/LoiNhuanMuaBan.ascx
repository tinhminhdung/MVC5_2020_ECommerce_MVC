                                ...
                                <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                    <tbody>
                                        ...
                                        <tr style="background: #ed1c24; color: #fff;">
                                            <td style="text-align: right; color: #fff; font-weight: bold" colspan="3">Tổng tiền gốc / Tổng:
                        <asp:Literal ID="lttongtien1" runat="server"></asp:Literal>
                                            </td>
                                            <td style="text-align: right; color: #fff; font-weight: bold" colspan="3">Tổng tiền đã chia / Tổng :
                        <asp:Literal ID="ltdachia1" runat="server"></asp:Literal>
                                            </td>
                                            <td style="text-align: center; color: #fff; font-weight: bold" colspan="4">Tổng tiền còn lại / Tổng : 
                        <asp:Literal ID="ltconlai1" runat="server"></asp:Literal>
                                            </td>
                                        </tr>

                                        <tr style="background: #ffa903; color: #fff;">
                                            <td style="text-align: right; color: #fff; font-weight: bold" colspan="3">Tổng tiền gốc / Trang :
                        <asp:Literal ID="lttongtien" runat="server"></asp:Literal>
                                            </td>
                                            <td style="text-align: right; color: #fff; font-weight: bold" colspan="3">Tổng tiền đã chia / Trang :
                        <asp:Literal ID="ltdachia" runat="server"></asp:Literal>
                                            </td>
                                            <td style="text-align: center; color: #fff; font-weight: bold" colspan="4">Tổng tiền còn lại / Trang : 

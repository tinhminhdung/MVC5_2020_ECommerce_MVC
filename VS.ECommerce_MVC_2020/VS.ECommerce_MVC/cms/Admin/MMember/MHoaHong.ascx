                ...
                <div class="widget">
                    <asp:Panel ID="pn_list" runat="server" Width="100%">
                                ...
                                <div class="span9">
                                    ...
                                    <div class="dataTables_length" id="sample_1_length">
                                        ...
                                        <asp:DropDownList ID="ddlkieu" CssClass="txt" AutoPostBack="true"
                                            ...
                                            <asp:ListItem Value="TrucTiep">Trực tiếp</asp:ListItem>
                                            <asp:ListItem Value="ChietKhau">Chiết khấu</asp:ListItem>
                                             <asp:ListItem Value="CapBac">Cấp bậc</asp:ListItem>
                                              <asp:ListItem Value="DongHuong">Đồng hưởng</asp:ListItem>
                                        </asp:DropDownList>
                        ...
                        <asp:Literal ID="lttongtien" runat="server"></asp:Literal>
                                                 ...
                                                 <td style="text-align: center; color: #fff; font-weight: bold">Tổng:
                                        ...
                                        <asp:Repeater ID="rp_pagelist" runat="server" OnItemCommand="rp_pagelist_ItemCommand">
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <%#AllQuery.MorePro.FormatMoney_NO(Eval("SoTienDuocHuong").ToString())%>
                                                    </td>
                                                    <td style="text-align: center;">

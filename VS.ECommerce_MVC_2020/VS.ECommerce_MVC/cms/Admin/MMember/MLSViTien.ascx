<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MLSViTien.ascx.cs" Inherits="VS.ECommerce_MVC.cms.Admin.MMember.MLSViTien" %>
            ...
            <div id="">
                <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
                    <ul>
                        ...
                        <li class="Last"><span>Danh sách lịch sử ví tiền</span></li>
                    </ul>
                </div>
                ...
                <div class="widget">
                    <asp:Panel ID="pn_list" runat="server" Width="100%">
                        <div class="widget-title">
                            <h4><i class="icon-list-alt"></i>&nbsp;Danh sách lịch sử ví tiền</h4>
                                ...
                                <div class="span9">
                                    ...
                                    <div class="dataTables_length" id="sample_1_length">
                                        ...
                                        <asp:DropDownList ID="ddlkieu" CssClass="txt" AutoPostBack="true"
                                            ...
                                            <asp:ListItem Value="RutTien">Rút tiền</asp:ListItem>
                                            <asp:ListItem Value="HoaHong">Hoa hồng</asp:ListItem>
                                            <asp:ListItem Value="ChuyenVi">Chuyển ví</asp:ListItem>
                                            <asp:ListItem Value="MuaHang">Mua hàng</asp:ListItem>
                                        </asp:DropDownList>
                                ...
                                <table cellspacing="0" style="border-collapse: collapse; margin-top: 18px" class="table table-striped table-bordered dataTable table-hover">
                                    <tbody>
                                        <tr style="background: #ffa903; color: #fff;">
                                            <td ></td>   <td ></td>
                                            <td style="text-align: center; color: #fff; font-weight: bold" colspan="3">Tổng tiền / Trang : 
                        <asp:Literal ID="ltCoin" runat="server"></asp:Literal>
                                            </td>
                                        </tr>
                                        <tr class="trHeader" style="height: 25px">
                                            <th style="font-weight: bold">Mã GD</th>
                                            <th style="font-weight: bold">Kiểu</th>
                                            <th style="font-weight: bold; width: 200px">Thành viên</th>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                     <td style="text-align: center;">
                                                        #<%#DataBinder.Eval(Container.DataItem,"MaGiaoDich")%>
                                                    </td>
                                                    <td style="text-align: center;">
                                                        <%#DataBinder.Eval(Container.DataItem,"KieuText")%>
                                                    </td>
                                                    <td style="text-align: center;">
                                                        <%#Commond.ShowThanhVien(DataBinder.Eval(Container.DataItem,"IDThanhVien").ToString())%> 
                                                    </td>
                                                    <td style="text-align: center;">
                                                        <%#AllQuery.MorePro.FormatMoney_NO(Eval("TongTien").ToString())%>
                                                    </td>
                                                    <td style="text-align: center;">

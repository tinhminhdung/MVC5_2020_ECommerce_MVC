    ...
    public partial class MLichSuRutTien : System.Web.UI.UserControl
    {
        ...
        public void LoadItems()
        {
            ...
            if (iitem.Count() > 0)
            {
                ...
                {
                    coin += Convert.ToDouble(iitem[i].SoTienCanRut.ToString());
                }
            ...
            ltpage.Text = Commond.PhantrangAdmin("/admin.aspx?u=LichSuThanhToan&kw=" + txtkeyword.Text + "&Tu=" + txtNgayThangNam.Text + "&Den=" + txtDenNgayThangNam.Text + "&trangthai=" + ddltrangthai.SelectedValue + "", Tongsobanghi, pages);
        }
            ...
            switch (e.CommandName)
            {
                ...
                case "Huy":
                    ...
                    if (abc != null)
                    {
                        ...
                        if (iitem.Count() > 0)
                        {
                            double TongSoVNDDaCo = Convert.ToDouble(iitem[0].ViBayMuoiPT);
                            ...
                            SMember.Name_Text("update Members set ViBayMuoiPT=" + ConglaiVND.ToString() + ",TongTienDaRut=" + CongRut.ToString() + "  where ID=" + abc.IDThanhVien.ToString() + "");
                        }
                        #endregion
                ...
                case "ThanhToan":
                    ...
                    //db.SubmitChanges();
                    SMember.Name_Text("update LichSuRutTien set TrangThai=1,NgayDuyet='" + DateTime.Now.ToString() + "',NguoiDuyet='" + MoreAll.MoreAll.GetCookies("UName").ToString() + "'  where ID=" + e.CommandArgument.ToString().Trim() + "");
                    this.LoadItems();
                    base.Response.Redirect(base.Request.Url.ToString().Trim());
                    return;
            }
        ...
        void Show()
        {
            Response.Redirect("/admin.aspx?u=LichSuThanhToan&kw=" + txtkeyword.Text + "&Tu=" + txtNgayThangNam.Text + "&Den=" + txtDenNgayThangNam.Text + "&trangthai=" + ddltrangthai.SelectedValue + "");
        }
        ...
        protected string Shwodatess(string str)
        {
            DateTime outputDateTimeValue;
            if (DateTime.TryParseExact(str, "dd/MM/yyyy HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.None, out outputDateTimeValue))
            {
                return outputDateTimeValue.ToString();
            }
            return str;
        }

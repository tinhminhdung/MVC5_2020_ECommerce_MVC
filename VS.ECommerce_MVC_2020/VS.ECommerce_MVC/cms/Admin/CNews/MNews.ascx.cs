...
namespace VS.ECommerce_MVC.cms.Admin.M_News
{
    public partial class MNews : System.Web.UI.UserControl
    {
        ...
        public void LoadItems()
        {
            ...
            {
                Vitri += " and (search LIKE N'" + FNews.SearchApproximate.Exec(FNews.ConvertVN.Convert(txtkeyword.Text.Trim())) + "' OR Brief LIKE N'" + FNews.SearchApproximate.Exec(txtkeyword.Text.Trim()) + "' OR search LIKE N'" + FNews.SearchApproximate.Exec(txtkeyword.Text.Trim()) + "')";
            }
            if (orderby.Length < 1)
            {
            ...
            //  try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        //obj.Create_Date = dcreatedate;
                        // obj.Modified_Date = denddate;
                        obj.Views = int.Parse(hdView.Value);
                        obj.Tags = this.txttags.Text;
                        obj.lang = this.lang;
                        obj.New = int.Parse(this.chknews.Checked ? "1" : "0");
                        obj.CheckBox1 = int.Parse(this.CheckBox1.Checked ? "1" : "0");
            ...
            switch (e.CommandName)
            {
                case "EditDetail":
                    ...
                    if (dtdetail.Count > 0)
                    {
                        ...
                        hdView.Value = dtdetail[0].Views.ToString();
                        ...
                        ltshowurl.Text = "<a href=\"" + ssl + "tin-tuc/" + dtdetail[0].TangName + ".html\" target=\"_blank\">" + ssl + "tin-tuc/" + dtdetail[0].TangName + ".html</a>";
        ...
        protected void btkiemtra_Click(object sender, EventArgs e)
        {
            ...
            if (hdinsertupdate.Value.Equals("insert"))
            {
                ...
                ltshowurl.Text = ssl + "tin-tuc/" + TangName + ".html";
                #endregion
            }
            else
            {
                ...
                ltshowurl.Text = ssl + "tin-tuc/" + TagName + ".html";
                #endregion
            }
        }
    }

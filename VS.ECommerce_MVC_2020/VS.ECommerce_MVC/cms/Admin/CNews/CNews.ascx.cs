    ...
    public partial class CNews : System.Web.UI.UserControl
    {
                ...
                case "EditDetail":
                    ...
                    if (table.Count > 0)
                    {
                        ...
                        if (table.Count > 0)
                        {
                            ...
                            ltshowurl.Text = "<a href=\"" + ssl + "danh-muc-tin/" + table[0].TangName + ".html\" target=\"_blank\">" + ssl + "danh-muc-tin/" + table[0].TangName + ".html</a>";
        ...
        protected void btkiemtra_Click(object sender, EventArgs e)
        {
            ...
            if (hd_insertupdate.Value.Equals("insert"))
            {
                ...
                ltshowurl.Text = ssl + "danh-muc-tin/" + TangName + ".html";
                #endregion
            }
            else
            {
                ...
                ltshowurl.Text = ssl + "danh-muc-tin/" + TagName + ".html";
                #endregion
            }
        }
    }

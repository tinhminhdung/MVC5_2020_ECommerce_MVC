...
namespace VS.ECommerce_MVC.cms.Admin.Video
{
    public partial class Videos : System.Web.UI.UserControl
    {
        ...
        public void LoadItems()
        {
            ...
            {
                Vitri += " and (Title LIKE N'" + Fproducts.SearchApproximate.Exec(txtkeyword.Text.Trim()) + "' OR Brief LIKE N'" + Fproducts.SearchApproximate.Exec(txtkeyword.Text.Trim()) + "' OR search LIKE N'" + Fproducts.SearchApproximate.Exec(txtkeyword.Text.Trim()) + "')";
            }
            if (orderby.Length < 1)
            {
            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        //obj.Create_Date = dcreatedate;
                        //obj.Modified_Date = denddate;
                        obj.Views = int.Parse(hdViews.Value);
                        obj.lang = this.lang;
                        obj.News = int.Parse(news);
                        obj.Status = int.Parse(status);
                        obj.Titleseo = txttitleseo.Text;
            ...
            switch (e.CommandName)
            {
                ...
                case "EditDetail":
                    ...
                    if (dtdetail.Count > 0)
                    {
                        ...
                        hdViews.Value = dtdetail[0].Views.ToString();
                        ...
                        ltshowurl.Text = "<a href=\"" + ssl + "video/" + dtdetail[0].TangName + ".html\" target=\"_blank\">" + ssl + "video/" + dtdetail[0].TangName + ".html</a>";
        ...
        protected void btkiemtra_Click(object sender, EventArgs e)
        {
            ...
            if (hdinsertupdate.Value.Equals("insert"))
            {
                ...
                ltshowurl.Text = ssl + "video/" + TangName + ".html";
                #endregion
            }
            else
            {
                ...
                ltshowurl.Text = ssl + "video/" + TagName + ".html";
                #endregion
            }
        }
    }

        ...
        <div class="widget-body">
            ...
            <table style="border-collapse: collapse" cellpadding="0" width="100%" border="0">
                ...
                <tr style="display:none">
                    <td colspan="3">
                        <strong style="text-transform: uppercase">
                            <img src="/Resources/admin/images/bullet-red.png" border="0" />Cấu hình Popup</strong>
                    </td>
                </tr>
                <tr style="display:none">
                    <td></td>
                    <td style="padding-left: 15px; width: 143px;">Ảnh Popup
                    </td>
                    <td>
                        <asp:TextBox ID="txtpopup" runat="server" CssClass="text image"></asp:TextBox>
                        <input id="btnnoimgaespop" type="button" onclick="BrowseServer('<%=txtpopup.ClientID %>','News');" value="Chọn ảnh" class="toolbar btns btn-info" />
                        <asp:Literal ID="lnkpopup" runat="server"></asp:Literal>
                        &nbsp;
                    </td>
                </tr>
                <tr style="display:none">
                    ...
                    <td align="left">
                        Rộng
                        <asp:TextBox CssClass="txt_css" ID="Rongpopup" runat="server" Width="45px">1</asp:TextBox>px&nbsp;
            <asp:TextBox CssClass="txt_css" ID="Caopopup" Visible="false"
                    runat="server" Width="45px">1</asp:TextBox><span style="font-size: 8pt; color: #ed1c24">
                        <em>(Vui lòng cho biết độ rộng của khung)</em></span>
                    </td>
                </tr>
                ...
                <tr style="display:none">
                    ...
                    <td>
                        <asp:TextBox CssClass="txt_css" ID="linkpop" runat="server" Width="200px"></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                 ...
                 <tr>
                   ...
                   <tr>
                    <td></td>
                    <td style="padding-left: 15px">Chát Facebook
                    </td>
                    <td>
                        <asp:TextBox CssClass="txt_css" ID="ChatFacebook" runat="server" Width="200px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td></td>

<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdvertisingKieuHai.ascx.cs" Inherits="VS.ECommerce_MVC.cms.Admin.Advertisings.AdvertisingKieuHai" %>
    ...
    <div id="">
        <div class="Block Breadcrumb ui-widget-content ui-corner-top ui-corner-bottom" id="Breadcrumb">
            <ul>
                ...
                <li class="Last"><span>Danh sách quảng cáo Kiểu 2</span></li>
            </ul>
        </div>
                        ...
                        <div class="span12">
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>Danh sách quảng cáo  Kiểu 2</h4>
                                </div>

                                <div style="color:red; font-weight:bold">Chú ý: Kiểu 2 này chỉ khác nhau là đăng ảnh cho nó nét hơn thôi</div>
                                        ...
                                        <div class="span6">
                                            <div id="sample_1_length" class="dataTables_length">
                                                ...
                                                <asp:DropDownList ID="ddlvalue" runat="server" AutoPostBack="true" Style="width: auto" OnSelectedIndexChanged="ddlvalue_SelectedIndexChanged">
                                                    ...
                                                    <asp:ListItem Value="1">Slide chính Destop - Trang chủ</asp:ListItem>
                                                    <asp:ListItem Value="3">Slide chính  Mobile - Trang chủ</asp:ListItem>
                                                    <asp:ListItem Value="2">4 Khối dưới banner chính - Trang chủ</asp:ListItem>
                                                    <asp:ListItem Value="4">Giới thiệu - Trang chủ</asp:ListItem>
                                                    <asp:ListItem Value="5">Tầm nhìn, sứ mệnh - Trang chủ</asp:ListItem>
                                                    <asp:ListItem Value="6">Giải thưởng - Trang chủ</asp:ListItem>
                                                    <asp:ListItem Value="7">Tiêu đề - Ứng dụng - Dưới khối Giải thưởng - Trang chủ</asp:ListItem>
                                                    <asp:ListItem Value="8">Ứng dụng - Dưới khối Giải thưởng  - Trang chủ</asp:ListItem>
                                                    <asp:ListItem Value="9">Báo chí nói về chúng tôi - Cạnh đối tác  - Trang chủ</asp:ListItem>
                                                    <asp:ListItem Value="10">Đối tác  - Trang chủ</asp:ListItem>
                                                    <asp:ListItem Value="11">Đánh giá  - Trang chủ</asp:ListItem>
                                                    <asp:ListItem Value="12">3 ảnh dưới Khối - Đánh giá  - Trang chủ</asp:ListItem>
                                                    <asp:ListItem Value="13">Ảnh to ở dưới chân trang - Trang chủ</asp:ListItem>
                                                    <asp:ListItem Value="14">Logo chân trang</asp:ListItem>

                                                    <asp:ListItem Value="18">Banner - TRÁCH NHIỆM XÃ HỘI</asp:ListItem>


                                                    <asp:ListItem Value="0">######## Module - GIỚI THIỆU ############</asp:ListItem>
                                                    <asp:ListItem Value="15">Giới thiệu về chúng tôi</asp:ListItem>
                                                    <asp:ListItem Value="16">Hành trình phát triển</asp:ListItem>
                                                    <asp:ListItem Value="17">1 bài viết dưới khối - Hành trình phát triển</asp:ListItem>

                                                    <asp:ListItem Value="0">######## Module - ĐẦU TƯ ############</asp:ListItem>
                                                    <asp:ListItem Value="19">Banner - ĐẦU TƯ</asp:ListItem>
                                                    <asp:ListItem Value="20">Mô hình P2P Lending - ĐẦU TƯ</asp:ListItem>
                                                    <asp:ListItem Value="21">Lợi ích khi đầu tư - ĐẦU TƯ</asp:ListItem>
                                                    <asp:ListItem Value="22">Lãi suất hấp dẫn, An toàn, Đa dạng, Tiện lợi - Lợi ích khi đầu tư - ĐẦU TƯ</asp:ListItem>
                                                    <asp:ListItem Value="23">Ai có thể đầu tư vào .. Credit - ĐẦU TƯ</asp:ListItem>
                                                    <asp:ListItem Value="24">Dễ dàng đầu tư chỉ với 4 bước - ĐẦU TƯ</asp:ListItem>

                                                    <asp:ListItem Value="0">######## Module - CÂU HỎI THƯỜNG GẶP ############</asp:ListItem>
                                                    <asp:ListItem Value="25">Banner - CÂU HỎI THƯỜNG GẶP</asp:ListItem>
                                                    <asp:ListItem Value="26">Nội dung From - Bạn có câu hỏi thắc mắc.. - CÂU HỎI THƯỜNG GẶP</asp:ListItem>


                                                    <asp:ListItem Value="0">######## Module HỖ TRỢ - HƯỚNG DẪN NẠP , RÚT TIỀN ############</asp:ListItem>
                                                    <asp:ListItem Value="27">Hướng dẫn nạp tiền/ rút tiền</asp:ListItem>

                                                    <asp:ListItem Value="0">######## Module - VAY TIỀN ############</asp:ListItem>
                                                    <asp:ListItem Value="28">Banner - VAY TIỀN </asp:ListItem>
                                                    <asp:ListItem Value="29">Mô tả sản phẩm - VAY TIỀN </asp:ListItem>
                                                    <asp:ListItem Value="30">LỢI ÍCH - VAY TIỀN </asp:ListItem>
                                                    <asp:ListItem Value="31">MÔ TẢ CHI TIẾT SẢN PHẨM - VAY TIỀN </asp:ListItem>
                                                </asp:DropDownList>
                    ...
                    <div class="row-fluid">
                        <div class="span12 sortable">
                                        ...
                                        <table id="tblinput" border="0" cellpadding="1" cellspacing="0" class="all" width="100%">
                                            ...
                                            <asp:Panel ID="PanelLink01" runat="server">
                                                <tr>
                                                    ...
                                                    <td align="left" style="height: 43px">Hình ảnh
                                                    </td>
                            ...
                            <asp:Literal ID="ltimgs" runat="server"></asp:Literal>
                                            ...
                                            <asp:Panel ID="PanelYoutube" runat="server"></asp:Panel>
                                            <tr>
                                                <td align="left" height="3" style="width: 100px"></td>
                                                ...
                                                <td></td>
                                                <td>
                                                    <asp:TextBox ID="txtYoutube" runat="server" Width="446px" Height="50px" TextMode="MultiLine"></asp:TextBox><span style="font-size: 8pt; color: #ed1c24"><em></em></span></td>
                                            </tr>

                                            <tr>
                                                <td align="left" style="width: 100px"></td>
                                                <td align="left">Vị trí quảng cáo
                                                </td>
                                                <td></td>
                                                <td>

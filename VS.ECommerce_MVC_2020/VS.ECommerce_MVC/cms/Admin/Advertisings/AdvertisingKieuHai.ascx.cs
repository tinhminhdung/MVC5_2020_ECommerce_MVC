...
{
    public partial class AdvertisingKieuHai : System.Web.UI.UserControl
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if ((this.flimage.FileName.Trim().Length > 0) && (this.flimage.PostedFile.ContentLength > 0))
                    {
                        ...
                        vimg = "/Uploads/advs/" + hash + flimage.FileName;
        ...
        {
            LoadItems();
            Response.Redirect("admin.aspx?u=AdvertisingsNews&value=" + ddlvalue.SelectedValue + "&st=" + ddlstatus.SelectedValue + "");
        }

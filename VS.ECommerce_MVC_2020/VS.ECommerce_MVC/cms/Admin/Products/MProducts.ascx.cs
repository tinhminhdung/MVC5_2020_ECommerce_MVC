    ...
    public partial class MProducts : System.Web.UI.UserControl
    {
            ...
            switch (e.CommandName)
            {
                case "update":
                    ...
                    if (dtdetail.Count > 0)
                    {
                        ...
                        ltshowurl.Text = "<a href=\"" + ssl + "san-pham/" + dtdetail[0].TangName + ".html\" target=\"_blank\">" + ssl + "san-pham/" + dtdetail[0].TangName + ".html</a>";
        ...
        protected void btkiemtra_Click(object sender, EventArgs e)
        {
            ...
            if (hdinsertupdate.Value.Equals("insert"))
            {
                ...
                ltshowurl.Text = ssl + "san-pham/" + TangName + ".html";
                #endregion
            }
            else
            {
                ...
                ltshowurl.Text = ssl + "san-pham/" + TagName + ".html";
                #endregion
            }
        }

                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            ...
                                            <tr valign="top">
                                                <td style="width: 150px">
                                                    ...
                                                    <%--<%=AllQuery.MorePro.Dongiapro()%>--%><cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" FilterType="Numbers" TargetControlID="txtprice"></cc1:FilteredTextBoxExtender>
                                                </td>
                                                <td>
                ...
                <asp:TextBox ID="txtindays" runat="server" CssClass="txt" Width="48px">365</asp:TextBox>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:CheckBox ID="Checknews" CssClass="txt_css2" runat="server" Font-Bold="False" Text="Sản phẩm Mới" />
                            ...
                            <asp:HiddenField ID="hdimgsmallEdit" runat="server" />
                              <asp:HiddenField ID="hdViews" runat="server" />
                        </div>
